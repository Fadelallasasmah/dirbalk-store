// DIRBALK — /api/waitlist
// Same-origin backend proxy for the simplified homepage registration
// (name + email + gender, no password), forwarding to the same Google
// Apps Script (with action: "waitlist").
